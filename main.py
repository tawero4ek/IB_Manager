...
class SearchFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.find_unused_windows_button = ctk.CTkButton(button_frame, text="Найти неиспользуемые окна",
                                                        command=self.find_unused_windows, font=("TimesNewRoman", 15),
                                                        width=300, height=50)
...
class IBManagerFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.design_folder_button = ctk.CTkButton(self.design_folder_frame, text="Выбрать папку",
                                                  command=self.select_folder, font=("TimesNewRoman", 15),
                                                  width=200, height=50)
        ...
        self.prj_file_label = ctk.CTkLabel(self.prj_file_frame, text="Выберите файл .prj:", font=("TimesNewRoman", 17))
