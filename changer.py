...
def execute_ib_command(file_path):
    try:
        ...
        alarm_palettes = re.findall(
            r'<FB Name="\w+\d*" Type="TAlarmViewer" TypeUUID="[^"]+".*?<Palette>(.*?)</Palette>',
            content,
            re.DOTALL,
        )
        ...
        def modify_state_data(palette_content):
            ...
            return re.sub(
                r'<StateData State="(\d+)" Foreground="(#[0-9a-fA-F]{6})" Background="(#[0-9a-fA-F]{6})" />',
                replacement,
                palette_content,
            )
        ...
        general_palettes_str = "\n".join(
            general_palettes_modified
        ).strip()  # Убираем лишние пустые строки
        alarm_palettes_str = "\n".join(
            alarm_palettes_modified
        ).strip()  # Убираем лишние пустые строки
        ...
        with open("result.iec_hmi", "r+", encoding="utf-8") as result_file:
            ...
            if general_palettes_str:
                if re.search(r"<EventPalette>", result_content) is None:
                    ...
                    result_content = re.sub(
                        r"(<EventPalette>\s*)(.*?)(\s*</EventPalette>)",
                        rf"\1{general_palettes_str}\2\3",
                        result_content,
                        flags=re.DOTALL,
                    )
            ...
            if alarm_palettes_str:
                if re.search(r"<AlarmPalette>", result_content) is None:
                    ...
                    result_content = re.sub(
                        r"(<AlarmPalette>\s*)(.*?)(\s*</AlarmPalette>)",
                        rf"\1{alarm_palettes_str}\2\3",
                        result_content,
                        flags=re.DOTALL,
                    )
...
def change_font_in_file(file_path):
    try:
        ...
        updated_content = re.sub(
            r"family:=&apos;.*?&apos;", r"family:=&apos;PT Sans&apos;", content
        )
...
def add_variables_to_files(prj_file, mnemo_file, event_logger_file):
    ...
    try:
        ...
        mnemo_content = mnemo_content.replace(
            "</InterfaceList>", mnemo_addition + "</InterfaceList>"
        )
        ...
        event_logger_content = event_logger_content.replace(
            "</InterfaceList>", event_logger_addition + "</InterfaceList>"
        )
        ...
        <Folder Name="IB" Comment="" Data="" UUID="3ESE2HQ3M5EUZIZODWES52KEL4">
            ...
            <SubWindowFBType Name="T_ChangeUser" ShowVarTypes="true" UUID="NEUKQC7QEKVEZGX4745NW4CR44">
                ...
                <FBNetwork>
                    ...
                    <FB Name="_Button_Simple" Type="T_Button_Simple" TypeUUID="F2YXTL3R7DCUDAA4ZOGSNBO2PE" Enabled="true" UUID="YIYX56QTJRMEJMIPCYTTIXEU6U" X="-68.25" Y="-4.375">
                    ...
                    <FB Name="_Button_Simple_0" Type="T_Button_Simple" TypeUUID="F2YXTL3R7DCUDAA4ZOGSNBO2PE" Enabled="true" UUID="GMKDG4OY7CWUZEBHFVXK4CJQA4" X="-65.25" Y="437.625">
                            ...
                            if fb_name in fb_source_uuids:
                                if value == "&apos;Фильтр&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="45366CB541EDF9CA622A56A7302D14F9.F4863EC2452A178A4460539D5B716C64" dx1="10" dx2="10" dy="-37" />\n'
                                    )
                                elif value == "&apos;Квитировать&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_2.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="B88BAF9E4D68CB0BCDDC00A580C06714.F4863EC2452A178A4460539D5B716C64" dx1="106" dx2="10" dy="106" />\n'
                                    )
                                elif value == "&apos;Квитировать все&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_5.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="48DA229A4C70727DB57E98A736BF2DFC.F4863EC2452A178A4460539D5B716C64" dx1="172" dx2="10" dy="191" />\n'
                                    )
                                elif value == "&apos;Печатать все&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_4.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="DC04E3E046FCC4941AEF56A681AAED82.F4863EC2452A178A4460539D5B716C64" dx1="0" dx2="0" dy="39" />\n'
                                    )
                                elif value == "&apos;Печать&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_1.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="D47253964A6C4DB41CF7199F86B53E61.F4863EC2452A178A4460539D5B716C64" dx1="0" dx2="0" dy="0" />\n'
                                    )
                                elif value == "&apos;Сохранить все&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_3.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="391EF1FA4A0B808BBB4998932C254548.F4863EC2452A178A4460539D5B716C64" dx1="0" dx2="0" dy="0" />\n'
                                    )
                                elif value == "&apos;Сохранить&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="{fb_name}.mouseLBPress" Destination="IS2RegEventButton_0.Registrer" SourceUUID="{fb_source_uuids[fb_name]}.299295AF47A6CCAC26009C964C5B47C5" DestinationUUID="B271696147A3C8029D8EFC914529897C.F4863EC2452A178A4460539D5B716C64" dx1="0" dx2="0" dy="0" />\n'
                                    )
                    ...
                    for value, fb_names in fb_names_dict.items():
                        for fb_name in fb_names:
                            if fb_name in fb_source_uuids:
                                if value == "&apos;Фильтр&apos;":
                                    new_connections.append(
                                        f'                        <Connection Source="::R_CfgEvViewer" Destination="{fb_name}.enabled" SourceUUID="::FECBBF4B450CEF8931F4AC8D85059C74" DestinationUUID="{fb_source_uuids[fb_name]}.15B097034B9BBE7CCD78E0A466A64239" />\n'
                                    )
                                elif (
                                    value == "&apos;Квитировать&apos;"
                                    or value == "&apos;Квитировать все&apos;"
                                ):
                                    new_connections.append(
                                        f'                        <Connection Source="::R_QuitAlarm" Destination="{fb_name}.enabled" SourceUUID="::034021C04AE0477941182098F6475ED1" DestinationUUID="{fb_source_uuids[fb_name]}.15B097034B9BBE7CCD78E0A466A64239" />\n'
                                    )
                                elif (
                                    value == "&apos;Печатать все&apos;"
                                    or value == "&apos;Печать&apos;"
                                    or value == "&apos;Сохранить все&apos;"
                                    or value == "&apos;Сохранить&apos;"
                                ):
                                    new_connections.append(
                                        f'                        <Connection Source="::R_Print" Destination="{fb_name}.enabled" SourceUUID="::CE3F4CAA4D3C816EBF47309CCBF6CA40" DestinationUUID="{fb_source_uuids[fb_name]}.15B097034B9BBE7CCD78E0A466A64239" />\n'
                                    )
            ...
            if in_event_block and "</FBNetwork>" in line and not data_connections_added:
                ...
                for value, fb_names in fb_names_dict.items():
                    for fb_name in fb_names:
                        if fb_name in fb_source_uuids:
                            if value == "&apos;Фильтр&apos;":
                                data_connections_content.append(
                                    f'                        <Connection Source="::R_CfgEvViewer" Destination="{fb_name}.enabled" SourceUUID="::FECBBF4B450CEF8931F4AC8D85059C74" DestinationUUID="{fb_source_uuids[fb_name]}.15B097034B9BBE7CCD78E0A466A64239" />\n'
                                )
                            elif (
                                value == "&apos;Квитировать&apos;"
...
def spread_to_nodes_function(nod_files):
    for file_path, at_settings_checked, at_ib_checked in nod_files:
        with open(file_path, "r", encoding="utf-8") as file:
        ...
        for line in lines:
            ...
            if "<InterfaceList>" in line:
                if at_settings_checked:
                    new_lines.append(
                        '		<SubApp Name="SQL" Type="NCYGMNWY5QJE3M6L7ZMIZ7WZHQ" Disabled="FALSE" Args="" ExecTimeout="10000" ShutdownTimeout="1000" GoodResult="0" Comment="" UUID="V2BBUSIITTWE5CPNVOEGQFFGGU" />\n'
                    )
                if at_ib_checked:
                    new_lines.append(
                        '		<SubApp Name="IB" Type="HJPAQQB2CXLURHLK6GED5RQMSE" Disabled="FALSE" Args="" ExecTimeout="10000" ShutdownTimeout="1000" GoodResult="0" Comment="" UUID="HN574UMNHXRE5ONHAHKWTDENKQ" />\n'
                    )
